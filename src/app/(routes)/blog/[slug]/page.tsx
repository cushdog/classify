    ...
    const fetchPost = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          setPost(camelCaseData.post);
          setComments(camelCaseData.comments);
  ...
  const handleSubmitComment = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const camelCaseComment = camelcaseKeys(comment);
        setComments([camelCaseComment, ...comments]);
        setNewComment('');
      } else {
                  ...
                  <Card key={comment.id}>
                    <CardHeader className="flex flex-row items-center space-x-4 pb-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs dark:text-white text-slate-500">
