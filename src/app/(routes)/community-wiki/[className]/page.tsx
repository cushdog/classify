...
import { ICourseWiki } from "@/db/Course Wikis/schema";
      ...
      case 2:
        return (
          <>
            <StyledPaper>
              <SectionTitle variant="h5">
                <TipsAndUpdatesIcon /> Course Tips
              </SectionTitle>
              {wiki?.courseTips ? (
    ...
    <Box sx={{ minHeight: "100vh", backgroundColor: "white" }}>
      <Box
        sx={{
          width: "100%",
          minHeight: "250px",
          background: `linear-gradient(to bottom right, #3f51b5, #5a67d8)`,
          padding: "20px",
          display: "flex",
          flexDirection: "column",
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", marginBottom: 2 }}>
          ...
          >
            {decodeURIComponent(className.toString()).replace(/\+/g, " ")} Wiki
          </Typography>
          <Chip
            label="Fall 2024"
            sx={{
